...
qk_tap_dance_action_t tap_dance_actions[] = {
  //Tap once for Hyper, twice for Caps Lock
  [TD_HYPR_CAPS]  = ACTION_TAP_DANCE_DOUBLE(KC_HYPR, KC_CAPS)
...
[_BL] = LAYOUT_ansi(
  ...
  TD(TD_HYPR_CAPS), KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,         KC_ENT,KC_PGUP,  \
...
[_FL] = LAYOUT_ansi(
  ...
  _______,_______,_______,BL_TOGG, BL_DEC,BL_INC, _______,_______,KC_MUTE,KC_VOLD,KC_VOLU,KC_BTN1, KC_MS_U, KC_BTN2, \
