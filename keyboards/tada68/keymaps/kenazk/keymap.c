...
qk_tap_dance_action_t tap_dance_actions[] = {
  //Tap once for GRV, twice for ESC
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
[_BL] = LAYOUT_ansi(
  TD(TD_GRV_ESC),  KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS, KC_EQL, KC_BSPC,KC_GRV, \
...
[_FL] = LAYOUT_ansi(
  ...
  _______,_______,_______,BL_TOGG, BL_DEC,BL_INC, _______,KC_MUTE,KC_VOLD,KC_VOLU,_______,KC_BTN1, KC_MS_U, KC_BTN2, \
